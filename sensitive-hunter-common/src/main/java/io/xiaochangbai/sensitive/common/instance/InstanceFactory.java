...
import io.xiaochangbai.sensitive.common.utils.ObjectUtil;
...
public final class InstanceFactory implements Instance {
    ...
    public static InstanceFactory getInstance() {
        return InstanceFactory.SingletonHolder.INSTANCE_FACTORY;
    }
    ...
    public <T> T threadSafe(Class<T> tClass) {
        return tClass.isAnnotationPresent(ThreadSafe.class) ? this.singleton(tClass) : this.multiple(tClass);
    }
